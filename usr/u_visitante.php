...
<meta name="keywords" content="mosquera, cundinamarca, negocio, microempresa, publicidad, ubicate" />
  ...
  <body>
    ...
    <section  class="col-sm-8 mx-auto" >
      <article>
        <h5>¿Qué tan confiable es?</h5>
<p>En la plataforma encontrarás gran variedad de productos y servicios ofertados, en algunas ocasiones de precios irrisorios. Y para asegurarnos de que todo sea legitimo, Ubícate hace un monitoreo mensual a todos los anunciantes, en donde se verifica la veracidad de los productos ofrecidos, que sea cierto que sí está a la venta y en el costo publicado. Ubícate hace responsable a el anunciante en caso de no encontrar en su establecimiento los productos anunciados en la plataforma.</p>
<h5>¿Cómo estar al día de todas las ofertas?</h5>
<p>Siguiendo las redes sociales de Ubicate estarás al día de todas las promociones, ya que una manera de vender más para los anunciantes es enviar a Ubicate imágenes e información de sus promociones, productos y servicios destacados a las redes sociales de Ubícate, donde se publicarán las mismas desde las redes sociales de la plataforma. </p>
<h5>¿Cómo puedo vender?</h5>
<p>Unirte a la comunidad de anunciantes Ubícate es muy sencillo; solo tienes que registrarte sin ningún costo, ingresar y publicar tus ofertas durante todo el mes gratuito. Dentro de la plataforma encontrarás la información especifica en caso de querer adquirir el servicio.</p>
      </article>
    </section>
    </main>
</div>
