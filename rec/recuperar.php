...
<meta name="keywords" content="mosquera, cundinamarca, negocio, microempresa, publicidad, ubicate" />
 ...
 <form action="enviar.php" method="POST" class="form-signin" style="margin-left: 10%; margin-right: 10%; text-align: center;">
    <div class="text-center mb-4"><br>
      <img src="../img/usr.png" width="85" height="85"><br>
      <h5>Recuperar contraseña</h5>
      <p>En vista de que no puedes ingresar dijita tu correo vinculado con tu cuenta ubicate para enviarte los pasos a seguir, buen día.</p>
    </div>
    <div class="form-label-group">
      <label class="for="firstName">Correo electrónico:</label><br> 
      <input type="email" name="email" required placeholder="correo@mail.com..." class="form-control" required><br>
    </div>
    <div style="margin-left: 20%; margin-right: 20%; text-align: center;">
      <button class="btn btn-lg btn-red btn-block" type="submit" name="submit" value="Enviar">Recuperar</button>
    </div>
 </form>
