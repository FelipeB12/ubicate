...
<div style="margin-right: 10%; margin-left: 10%; text-align: center;">
      <a href="unete.php">Regístrate y empieza a vender</a>
  <h5>Aquí puede encontrar toda la información del vendedor y producto para comprar cualquier cosa que necesite.</h5>
    <p>Busca por Negocio-Producto-Descripción-Precio</p>   
