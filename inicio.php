 ...
 <nav class="navbar navbar-expand-sm navbar-dark bg-danger">
      ...
      <div class="collapse navbar-collapse" id="navbarsExample03">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="inicio.php">Ingresar</a>
          </li>
          <li class="nav-item">
    ...
    <form action="validar.php" method="POST" class="form-signin" style="margin-left: 10%; margin-right: 10%; text-align: center;">
      <div class="text-center mb-4"><br>
        <img src="img/usr.png" width="85" height="85">
      </div>
      <div class="form-label-group">
        <input type="email" id="inputEmail" name="mail" class="form-control" placeholder="Correo electrónico" required autofocus><br>
      </div>
      <div class="form-label-group">
      ...
      <div style="margin-left: 20%; margin-right: 20%; text-align: center;">
       <button class="btn btn-lg btn-red btn-block" type="submit" ">Iniciar sesión</button>
      </div>
    </form>
    <div style="text-align: left; margin-left: 10%">
      <a href="rec/recuperar.php">¿Olvidó su contraseña?</a><br>
      <a href="unete.php">Registrarse.</a>
    </div>
